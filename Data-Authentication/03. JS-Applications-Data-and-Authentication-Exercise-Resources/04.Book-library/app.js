...
function createHtmlBook(book, id) {
    let titleTd = ce('td', undefined, book.title);
    let authorTd = ce('td', undefined, book.author);
    let editBtn = ce('td', undefined, 'Edit');
    let deleteBtn = ce('td', undefined, 'Delete');
    deleteBtn.addEventListener('click', deleteBook);
    let buttonsTd = ce('td', undefined, editBtn, deleteBtn);
    let tr = ce('tr', undefined, titleTd, authorTd, buttonsTd);
    tr.dataset.id = id;
    return tr;
}
